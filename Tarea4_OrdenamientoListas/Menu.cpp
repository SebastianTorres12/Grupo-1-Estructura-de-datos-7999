...
void Menu::menuPrincipal(){
	int cedula,horas,opcMP=0, opcMR=0,opcMB=0,opcML=0,opcOL=0,opcMLC=0,tamNombre=0,tamApellido=0;
	bool repetir=true,repetir2=true,repetir3=true,repetir1=true,repetir4=true,repetir5=true,vCedula=true,vNombre=true,vApellido=true;
    ...
    const char *opciones1[]={"Ingresar en lista simple.","Ingresar en lista doble.","Ingresar en lista circular.","Retornar al menu principal."};
